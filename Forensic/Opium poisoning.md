...
**Definition** Opium is a sleep-inducing (somniferous) narcotic poison derived from the unripe fruit capsules of the poppy plant, _**Papaver somniferum**_.

**Introduction** Opium contains about 25 alkaloids, which are complex nitrogenous bases. In forensic toxicology, it is classified as a **Cerebral Neurotic Poison**.

**Active Principles**:

1. **Phenanthrene derivatives:**
    - **Morphine (10%):** The main narcotic constituent; bitter taste, white powder.
    - **Codeine (0.5%):** Used as an antitussive.
    - **Thebaine (0.3%):** A minor alkaloid.
2. **Benzyl-isoquinoline derivatives:** (No significant CNS effects)
    - **Papaverine (1%)**
    - **Noscapine (6%)**
...
- **Marquis Test:** A spot test where the suspected sample + sulfuric acid/formalin turns **purple-red to violet**.
- **Mandelin Test:** Morphine produces a **blue-gray** color.

**II. Differential Diagnosis**:

- **Intracranial hemorrhage** (CVA).
- **Alcohol intoxication** (Alcohol breath, dilated pupils).
- **Organophosphate (OPC) poisoning** (Kerosene smell, SLUDGE signs).
- **Phenol poisoning** (Leathery stomach, carboluria).

---

#### **Management**

**I. Stabilization (ABCD)**:

- Maintain a patent airway and provide oxygen or mechanical ventilation if necessary.
...
- **Naloxone:** The specific narcotic antagonist.
- **Dose:** 0.4–2 mg IV/IM, repeated every 2–3 minutes until the patient responds (up to 10 mg).

**IV. Supportive Care**:

- IV fluids to combat hypotension.
- **Catheterization** for urinary retention (due to increased sphincter tone).
