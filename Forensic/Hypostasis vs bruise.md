[[Mechanical injuries]]
In university examinations, differentiating between a **Bruise (Contusion)** and **Postmortem Hypostasis (Postmortem Staining/Livor Mortis)** is a classic "Difference Between" question that tests a student's fundamental understanding of antemortem trauma versus postmortem changes.
...
- **Bharatiya Nyaya Sanhita (BNS), 2023**
    - **Section 2(14):** Defines **Injury** as any harm illegally caused to any person in body, mind, reputation, or property.
    - **Section 114:** Relates to voluntarily causing **Hurt**. Bruises are generally classified as simple hurt.
    - **Section 116:** Defines **Grievous Hurt**. If a bruise is associated with injury to vital internal organs, it may be classified here.

---

### **Difference Between Bruise and Postmortem Hypostasis**
...
- **★ The Incision Test:** This is the "gold standard" used during an autopsy to differentiate the two. If a doctor makes an incision and the blood flows out or washes away, it is hypostasis.
- **Contact Pallor:** In hypostasis, areas of the body directly pressed against a surface (like shoulder blades or buttocks) remain pale because the capillaries are compressed. This is called **contact flattening** or **blanching**.
- **Fixation:** Hypostasis gets "fixed" (does not move or blanch) after 8–12 hours.
- **Vibices:** These are tiny, confluent, round-to-oval hemorrhages within an area of hypostasis caused by the postmortem rupture of capillaries.

---

### **Viva Questions**

**Q1: Can hypostasis be seen in internal organs?** **Model Answer:** Yes. Hypostasis occurs in the dependent parts of all internal organs, such as the lungs (can simulate pneumonia) or the heart (can simulate myocardial infarction).

**Q2: What is "Ectopic/Migratory Bruise"?** **Model Answer:** It is a bruise that appears at a site other than the site of impact due to the gravity shifting of blood along fascial planes, such as "black eyes" (raccoon eyes) resulting from a forehead or skull base injury.

---

### **Quick Revision Summary**

- **Bruise:** Antemortem + Trauma + Clotted blood (cannot wash) + Color changes.
- **Hypostasis:** Postmortem + Gravity + Blood in vessels (can wash) + Blanching.
- **Primary Law:** BNS Section 2(14) for Injury and 114 for Hurt.
- **Key Site:** Hypostasis is always in the **dependent parts** unless the body was moved.